...
1. Envie descrição detalhada para o mantenedor via GitHub Security Advisories ou contato privado do repositório [high-compression-log-router](https://github.com/SrSatriano/high-compression-log-router).
