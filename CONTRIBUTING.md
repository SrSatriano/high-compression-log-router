...
Obrigado por considerar uma contribuição para **Roteador de logs de alta compressão**.

## Como começar

1. Faça um fork do repositório [high-compression-log-router](https://github.com/SrSatriano/high-compression-log-router).
