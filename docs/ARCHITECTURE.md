# Arquitetura — Roteador de logs de alta compressão

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Servidor TCP que comprime com Zstd/LZ4 e bench comparativo.
...
|------------|------------------|
| Bench | Bench LZ4 vs Zstd |
| Servidor | Servidor TCP assíncrono |
| Binário | Binário bench_compression |
| Nível | Nível Zstd configurável |
| Encaminhamento | Encaminhamento cold storage (roadmap) |
